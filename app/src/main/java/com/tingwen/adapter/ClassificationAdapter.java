 ...
 */
public class ClassificationAdapter extends ListBaseAdapter<ClassificationBean.ResultsBean> {

    private String id;//正在播放的新闻

    public ClassificationAdapter(Context context, List<ClassificationBean.ResultsBean> list) {
        super(context);
        mDataList=list;
    }
    ...
    public void onBindItemHolder(SuperViewHolder holder, final int position) {
        ...
        ClassificationBean.ResultsBean resultsBean = mDataList.get(position);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClassificationBean.ResultsBean downLoadBean = mDataList.get(position);
