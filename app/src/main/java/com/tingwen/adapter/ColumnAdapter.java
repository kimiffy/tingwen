 ...
 */
public class ColumnAdapter extends ListBaseAdapter<ColumnNewsBean.ResultsBean> {

    private String id;//正在播放的新闻
    public ColumnAdapter(Context context, List<ColumnNewsBean.ResultsBean> list) {
        super(context);
        mDataList = list;
    }
    ...
    public void onBindItemHolder(SuperViewHolder holder, final int position) {
        ColumnNewsBean.ResultsBean resultsBean = mDataList.get(position);
        ...
        TouchUtil.setTouchDelegate(download,30);
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ColumnNewsBean.ResultsBean downLoadBean = mDataList.get(position);
