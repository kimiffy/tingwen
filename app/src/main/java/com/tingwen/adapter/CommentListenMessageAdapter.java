 ...
 */
public class CommentListenMessageAdapter extends BaseAdapter {

    private List<ListenMessageDetailBean.ResultsBean.ChildCommentBean> list;
    private Context mContext;

    private int currentPosition;
    private CommentListener mListener;
    private ListenMessageDetailBean.ResultsBean mListenCircle;

    public CommentListenMessageAdapter(Context context, List<ListenMessageDetailBean.ResultsBean.ChildCommentBean> list, ListenMessageDetailBean.ResultsBean listenerCircle
    ) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ListenMessageDetailBean.ResultsBean.ChildCommentBean map = list.get(position);
        ...
        ListenMessageDetailBean.ResultsBean.ChildCommentBean.UserBean user = map.getUser();
        ...
        spannableString.setSpan(new ClickableSpan() {
            ...
            public void updateDrawState(TextPaint ds) {
                ...
                ds.setColor(Color.parseColor("#33475F"));
            }
    ...
    public interface CommentListener {
        void onItemClick(ListenMessageDetailBean.ResultsBean.ChildCommentBean suggest, ListenMessageDetailBean.ResultsBean listenerCircle, int position);
    }

    private void toOthers(ListenMessageDetailBean.ResultsBean.ChildCommentBean.UserBean user) {
    ...
    private void toOthers2(ListenMessageDetailBean.ResultsBean.ChildCommentBean.ToUserBean to_user) {
