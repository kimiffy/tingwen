...
public class FeedbackDetailCommentAdapter  extends BaseAdapter  {
    ...
    public FeedbackDetailCommentAdapter(Context context, List<CommentDetailBean.ResultsBean.ChildCommentBean> list, CommentDetailBean.ResultsBean feedBack
    ) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final CommentDetailBean.ResultsBean.ChildCommentBean map = list.get(position);
        ...
        spannableString.setSpan(new ClickableSpan() {
            @Override
            public void onClick(View widget) {
                CommentDetailBean.ResultsBean.ChildCommentBean.ToUserBean to_user = map.getTo_user();
                toOthers2(to_user);
            }
    ...
    public interface CommentListener {
        void onItemClick(CommentDetailBean.ResultsBean.ChildCommentBean suggest, CommentDetailBean.ResultsBean feedback, int position);
    }

    private void toOthers(CommentDetailBean.ResultsBean.ChildCommentBean.UserBean user) {
    ...
    private void toOthers2(CommentDetailBean.ResultsBean.ChildCommentBean.ToUserBean to_user) {
