 ...
 */
public class FollowListAdapter extends ListBaseAdapter<FollowListBean.ResultsBean> {
    private Context context;
    public FollowListAdapter(Context context, List<FollowListBean.ResultsBean> list) {
        super(context);
        mDataList=list;
    ...
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        FollowListBean.ResultsBean bean = mDataList.get(position);
