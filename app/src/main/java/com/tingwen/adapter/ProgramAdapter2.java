 ...
 */
public class ProgramAdapter2 extends RecyclerView.Adapter<ProgramAdapter2.programViewHolder> implements View.OnClickListener {
    ...
    public ProgramAdapter2(Context context, List<ProgramBean.ResultsBean> list) {
    ...
    public programViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_program_list_2, parent, false);
    ...
    public void onBindViewHolder(programViewHolder holder, int position) {
        final ProgramBean.ResultsBean bean = dataList.get(position);
        ...
        holder.follow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (FollowUtil.isFollowed(id)) {
                    followListener.delete2(id);
                } else {
                    followListener.follow2(id);
                }
            }
        });
