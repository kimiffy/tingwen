 ...
 */
public class PayPop2 extends BasePopupWindow implements View.OnClickListener{
    private View popupView;

    public PayPop2(Activity context) {
        super(context);
        bindEvent();
    }
    @Override
    ...
    public View onCreatePopupView() {
        popupView = LayoutInflater.from(getContext()).inflate(R.layout.popup_pay_2, null);
        return popupView;
    }
    ...
    private void bindEvent() {
        if (popupView != null) {
            ...
            popupView.findViewById(R.id.ll_tingbi_pay).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_zfb_pay:
                ...
                break;
            case R.id.ll_tingbi_pay:
                payChooseListener.TingPay();
                break;
            case R.id.tv_cancel:
