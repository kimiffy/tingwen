...
public class ColorPhrase {
    ...
    private ColorPhrase(CharSequence pattern) {
        ...
        formatted = null;
        separator = "{}";// initialize the default separator  包裹需要替换颜色的string 默认符号
        outerColor = 0xFF666666;//initialize the default value 外部string  默认颜色
        innerColor =0xFFE6454A;//initialize the default value  内部 string 默认颜色
    }
