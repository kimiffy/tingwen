...
import com.tingwen.utils.AudioManager;
import com.tingwen.utils.DialogManager;
...
public class AudioRecordButton extends Button  {
	...
	public AudioRecordButton(final Context context, AttributeSet attrs) {
		...
		// 这里没有判断储存卡是否存在，有空要判断
		String dir = Environment.getExternalStorageDirectory()+ "/tingwen_recorder_audios";
		...
		setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
                ...
                boolean isRecord = (permission == PackageManager.PERMISSION_GRANTED)&&
                        (write == PackageManager.PERMISSION_GRANTED);
                if(isRecord) {
                    mReady = true;
                    mAudioManager.prepareAudio();
                }else{
                    Toast.makeText(context,"请在设置里面申请录音和文件读写权限", Toast.LENGTH_SHORT).show();
                }
				return false;
			}
		});
