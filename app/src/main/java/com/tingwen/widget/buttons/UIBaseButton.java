package com.tingwen.widget.buttons;
...
public class UIBaseButton extends Button {
    ...
    protected void init(final Context context, final AttributeSet attrs) {
        ...
        unpressedColor = typedArray.getColor(R.styleable.UIButton_color_unpressed, Color.TRANSPARENT);
        typedArray.recycle();
